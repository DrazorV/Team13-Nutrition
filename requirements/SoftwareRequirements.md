...
| Κατηγορία | Περιγραφή |
| :----------------------| :---------|
| Android | * Το σύστημα θα αναπτυχθεί στο περιβάλλον του Android Studio <br/> * Το σύστημα θα μπορεί να εκτελείται σε ηλεκτρονικές με λογισμικό Android 5.1 (Lollipop) ή νεότερη.|
