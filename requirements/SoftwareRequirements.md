...
Το έγγραφο αυτό περιεχέι τις απαιτήσεις του παρόντος συστήματος καθώς και μια αναλυτική παρουσίαση των δυνατοτήτων του. Επίσης περιεχέι μια επεξήγηση των περιπτώσεων χρήσης του καθώς και υποθέσεις και εξαρτίσεις, απαραίτητες για την υλοποίηση του συστήματος. Επιπρόσθετα περιλαμβάνεται μια σύνοψη των ειδικών απαιτήσεων του συστήματος άλλα και συμπληρωματικές προδιαγραφές όπως οι μη λειτουργικές απαιτήσεις άλλα και οι περιορισμούς σχεδίασης και υλοποίησης. Στην παράγραφο "Επισκόπηση" περιλαμβάνεται οδηγός των περιεχόμενων του εγγράφου.
